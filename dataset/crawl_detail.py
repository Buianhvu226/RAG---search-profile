...
def crawl_profile_detail(url):
    ...
    # Lấy nội dung chi tiết từ profile-content
    ...
    # Lấy thông tin liên hệ từ profile-contact
...
# Hàm crawl toàn bộ với đa luồng
def crawl_all_profiles(base_url, max_pages=2080, max_workers=20):
    all_data = []
    
    # Crawl các trang danh sách
    page_urls = [base_url if page == 1 else f"{base_url}page/{page}/" for page in range(1, max_pages + 1)]
        ...
        for future in as_completed(future_to_url):
            ...
            try:
                ...
                if page_data:
                    ...
                    print(f"Không tìm thấy dữ liệu ở {url}")
            except Exception as e:
...
data = crawl_all_profiles(base_url, max_pages=2080, max_workers=20)
